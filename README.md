...
|-------------|-------------|----------|
| Cleaned Dataset |  Titanic dataset with missing values handled, Cabin dropped, and categorical variables encoded | [Cleaned Dataset](data/processed/) |
| Brief Report | Summary of key findings and methodology | [Report Doc](reports/) |
| Jupyter Notebook | NotebookFull EDA workflow including data loading, cleaning, visualization, and insight documentation | [Notebook](notebooks/) |
